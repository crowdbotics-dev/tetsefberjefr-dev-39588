...
## Project Structure
    ...
    ├── tetsefberjefr_dev_39588  # Django project configurations
...
1. Clone this repo and `cd tetsefberjefr_dev_39588`
...
2. Clone this repo and `cd tetsefberjefr_dev_39588`
